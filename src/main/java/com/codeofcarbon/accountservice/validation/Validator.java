package com.codeofcarbon.accountservice.validation;

import com.codeofcarbon.accountservice.model.*;
import com.codeofcarbon.accountservice.repository.*;
import com.codeofcarbon.accountservice.security.AppPasswordEncoder;
...
public class Validator {
    ...
    public Role validateRole(User user, String roleName, AdminService.Operation operation) {
