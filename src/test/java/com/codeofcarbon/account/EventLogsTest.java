...
public class EventLogsTest extends SpringTest {
    ...
    private final String maxMusLower = new TestRequest(maxMus)
            .setProps("email", "maxmustermann@acme.com").toJson();
    private final String maxMusWrongPassword = new TestRequest(maxMus)
            .setProps("password", "none").toJson();
    private final String petrPetrovWrongPassword = new TestRequest(petrPetrov)
            .setProps("password", "none").toJson();
    private final String maxMusWrongEmail = new TestRequest(maxMus)
            .setProps("email", "maxmustermann@google.com").toJson();
    private final String captainNemoWrongUser = captainNemo.toJson();
    private final String jDNewPass = new TestRequest(johnDoe)
            .setProps("password", "aNob5VvqzRtb").toJson();
    private final String jDPass = new TestRequest()
            .setProps("new_password", "aNob5VvqzRtb").toJson();

    private final String firstResponseAdminApi = convert(new String[]{
            new TestRequest().setProps("id", 1)
                    .setProps("name", "John")
                    .setProps("lastname", "Doe")
                    .setProps("email", "johndoe@acme.com")
                    .setProps("roles", new String[]{"ROLE_ADMINISTRATOR"}).toJson(),
            new TestRequest().setProps("id", 2)
                    .setProps("name", "Ivan")
                    .setProps("lastname", "Ivanov")
                    .setProps("email", "ivanivanov@acme.com")
                    .setProps("roles", new String[]{"ROLE_AUDITOR", "ROLE_USER"}).toJson(),
            new TestRequest().setProps("id", 3)
                    .setProps("name", "Max")
                    .setProps("lastname", "Mustermann")
                    .setProps("email", "maxmustermann@acme.com")
    ...
    private final String[] auditorResponseApi = new String[]{
            new TestRequest().setProps("action", "CREATE_USER")
            ...
            new TestRequest().setProps("action", "CREATE_USER")
                    ...
                    .setProps("path", "/api/auth/signup").toJson(),
            new TestRequest().setProps("action", "GRANT_ROLE")
            ...
            new TestRequest().setProps("action", "CREATE_USER")
                    ...
                    .setProps("path", "/api/auth/signup").toJson(),
            new TestRequest().setProps("action", "LOGIN_FAILED")
            ...
            new TestRequest().setProps("action", "GRANT_ROLE")
                    ...
                    .setProps("path", "/api/admin/user/role").toJson(),
            new TestRequest().setProps("action", "REMOVE_ROLE")
                    .setProps("subject", "johndoe@acme.com")
                    .setProps("object", "Remove role ACCOUNTANT from petrpetrov@acme.com")
                    .setProps("path", "/api/admin/user/role").toJson(),
            new TestRequest().setProps("action", "DELETE_USER")
                    .setProps("subject", "johndoe@acme.com")
                    .setProps("object", "petrpetrov@acme.com")
                    .setProps("path", "/api/admin/user").toJson(),
            new TestRequest().setProps("action", "CHANGE_PASSWORD")
                    .setProps("subject", "johndoe@acme.com")
                    .setProps("object", "johndoe@acme.com")
                    .setProps("path", "/api/auth/changepass").toJson(),
            new TestRequest().setProps("action", "ACCESS_DENIED")
            ...
            new TestRequest().setProps("action", "LOGIN_FAILED")
                    ...
                    .setProps("object", "/api/empl/payment")
                    .setProps("path", "/api/empl/payment").toJson(),
            new TestRequest().setProps("action", "BRUTE_FORCE")
                    .setProps("subject", "maxmustermann@acme.com")
                    .setProps("object", "/api/empl/payment")
                    .setProps("path", "/api/empl/payment").toJson(),
            new TestRequest().setProps("action", "LOCK_USER")
                    .setProps("subject", "maxmustermann@acme.com")
                    .setProps("object", "Lock user maxmustermann@acme.com")
                    .setProps("path", "/api/admin/user/access").toJson(),
            new TestRequest().setProps("action", "UNLOCK_USER")
                    .setProps("subject", "johndoe@acme.com")
    ...
    private CheckResult testGetAdminApi(int status, String user, String answer, String message) {
    ...
    CheckResult testPutAccessApi(HttpStatus status, String user, String reqUser,
    ...
    CheckResult testLocking(String user, String message) {
    ...
    CheckResult testDeleteAdminApi(String user) {

        HttpResponse response = checkResponseStatus(user, "", HttpStatus.OK.value(),
                adminApi + "petrpetrov@acme.com", "DELETE", "Trying to delete user");
